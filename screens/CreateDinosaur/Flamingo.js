...
export default function Flamingo({ navigation }) {
  return (
    <ImageBackground
      source={require("../../images/CreateDinosaur/Flamingo/bg.png")}
      style={styles.backgroundImage}
    >
      <View style={styles.container}>
        <ImageBackground
          source={require("../../images/CreateDinosaur/Flamingo/items.png")}
